...
const Search = forwardRef<HTMLInputElement, SearchProps>(({loading, wapperProps, className, onSubmit, ...rest}, ref) => {
    return (
        <form className="flex gap-2 justify-between items-center w-screen max-w-sm bg-black/5 rounded-3xl pl-3 h-8 border border-app-primary/5 outline-2 outline-transparent has-[input:focus]:outline-app-primary/25 py-1.5 ">
